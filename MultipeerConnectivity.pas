...
{$include multipeerconnectivity/UndefinedTypes.inc}

{$define TYPES}
{$include multipeerconnectivity/Sources.inc}
{$undef TYPES}
...
{$include multipeerconnectivity/InlineFunctions.inc}
