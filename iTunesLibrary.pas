...
{$include ituneslibrary/UndefinedTypes.inc}

{$define TYPES}
{$include ituneslibrary/Sources.inc}
{$undef TYPES}
...
{$include ituneslibrary/InlineFunctions.inc}
